...
const generateUsers = () => {
  ...
  const combinedSpecialties: string[][] = [[], [], ['Инструктор по безопасности'], [], ['Электромонтер'], [], ['Составитель поездов'], [], ['Проводник'], ['Помощник машиниста'], ['Электромонтер', 'Инструктор по безопасности']];
...
export const defaultKnowledgeScope: Record<string, string[]> = {
  'Машинист электровоза': [
    'safety', 'safety-signals', 'safety-signals-light', 'safety-signals-sound', 'safety-signals-hand',
    'safety-zones', 'safety-electric',
    'technical', 'technical-maintenance', 'technical-maintenance-to1', 'technical-maintenance-to2', 'technical-maintenance-to3',
    'technical-repair', 'technical-diagnostics', 'technical-diagnostics-equipment',
    'operations', 'operations-shift', 'operations-driving', 'operations-driving-modes',
    'regulations', 'regulations-pte', 'regulations-instructions', 'regulations-norms',
    'emergency', 'emergency-failures', 'emergency-stops', 'emergency-accidents', 'emergency-accidents-collision',
    'equipment', 'equipment-electric', 'equipment-electric-modern', 'equipment-electric-classic',
    'health', 'health-medical', 'health-protection', 'health-firstaid',
    'training', 'training-qualification', 'training-certification',
  ],
  'Помощник машиниста': [
    'safety', 'safety-signals', 'safety-signals-light', 'safety-signals-sound', 'safety-signals-hand',
    'safety-zones', 'safety-electric',
    'technical', 'technical-maintenance', 'technical-maintenance-to1', 'technical-maintenance-to2',
    'technical-diagnostics',
    'operations', 'operations-shift', 'operations-driving', 'operations-driving-modes',
    'regulations', 'regulations-pte', 'regulations-instructions',
    'emergency', 'emergency-failures', 'emergency-stops', 'emergency-accidents',
    'equipment', 'equipment-electric', 'equipment-electric-modern', 'equipment-electric-classic',
    'equipment-diesel', 'equipment-diesel-cargo', 'equipment-diesel-passenger',
    'health', 'health-medical', 'health-protection', 'health-firstaid',
    'training', 'training-qualification', 'training-internship',
  ],
  'Диспетчер': [
    'safety', 'safety-signals', 'safety-signals-light', 'safety-signals-sound', 'safety-zones',
    'operations', 'operations-shift', 'operations-docs', 'operations-driving',
    'regulations', 'regulations-pte', 'regulations-instructions', 'regulations-norms',
    'emergency', 'emergency-failures', 'emergency-stops', 'emergency-accidents', 'emergency-accidents-collision',
    'documentation', 'documentation-travel', 'documentation-logs', 'documentation-reporting',
    'health', 'health-medical', 'health-protection',
    'training', 'training-qualification', 'training-certification',
  ],
  'Проводник': [
    'safety', 'safety-signals', 'safety-signals-light', 'safety-zones',
    'operations', 'operations-shift', 'operations-docs',
    'regulations', 'regulations-instructions', 'regulations-norms',
    'emergency', 'emergency-failures', 'emergency-stops', 'emergency-accidents',
    'documentation', 'documentation-travel', 'documentation-logs',
    'environment', 'environment-requirements', 'environment-waste',
    'health', 'health-medical', 'health-protection', 'health-firstaid',
    'training', 'training-qualification', 'training-certification',
  ],
  'Слесарь по ремонту': [
    'safety', 'safety-electric', 'safety-zones',
    'technical', 'technical-maintenance', 'technical-maintenance-to1', 'technical-maintenance-to2', 'technical-maintenance-to3',
    'technical-repair', 'technical-diagnostics', 'technical-diagnostics-equipment',
    'regulations', 'regulations-instructions', 'regulations-norms',
    'equipment', 'equipment-electric', 'equipment-diesel',
    'environment', 'environment-requirements', 'environment-waste',
    'health', 'health-medical', 'health-protection', 'health-firstaid',
    'training', 'training-qualification', 'training-internship',
  ],
  'Электромонтер': [
    'safety', 'safety-electric', 'safety-zones',
    'technical', 'technical-maintenance', 'technical-repair', 'technical-diagnostics', 'technical-diagnostics-equipment',
    'regulations', 'regulations-instructions', 'regulations-norms',
    'equipment', 'equipment-electric', 'equipment-electric-modern', 'equipment-electric-classic',
    'environment', 'environment-requirements', 'environment-waste',
    'health', 'health-medical', 'health-protection', 'health-firstaid',
  ...
  'Инженер-путеец': [
    'safety', 'safety-signals', 'safety-zones',
    'technical', 'technical-maintenance', 'technical-repair', 'technical-diagnostics',
    'operations', 'operations-docs',
    'regulations', 'regulations-pte', 'regulations-instructions', 'regulations-norms',
    'emergency', 'emergency-failures', 'emergency-accidents', 'emergency-accidents-collision',
    'documentation', 'documentation-travel', 'documentation-logs', 'documentation-reporting',
    'environment', 'environment-requirements', 'environment-waste', 'environment-green',
    'health', 'health-medical', 'health-protection', 'health-firstaid',
    'training', 'training-qualification', 'training-certification',
  ],
  'Составитель поездов': [
  ...
  'Начальник станции': [
    ...
    'health', 'health-medical', 'health-protection', 'health-firstaid',
    'training', 'training-qualification', 'training-internship', 'training-certification',
  ],
  'Дежурный по станции': [
    'safety', 'safety-signals', 'safety-signals-light', 'safety-signals-sound', 'safety-signals-hand',
    'safety-zones',
  ...
  'Осмотрщик вагонов': [
    ...
    'technical-repair', 'technical-diagnostics', 'technical-diagnostics-equipment',
    'regulations', 'regulations-instructions', 'regulations-norms',
    'emergency', 'emergency-failures', 'emergency-stops',
    'documentation', 'documentation-travel', 'documentation-logs',
    'health', 'health-medical', 'health-protection', 'health-firstaid',
    'training', 'training-qualification', 'training-internship',
  ],
  'Кондуктор': [
    'safety', 'safety-signals', 'safety-signals-light', 'safety-zones',
    'operations', 'operations-shift', 'operations-docs',
    'regulations', 'regulations-instructions',
    'emergency', 'emergency-failures', 'emergency-stops',
    'documentation', 'documentation-travel',
    'health', 'health-medical', 'health-protection', 'health-firstaid',
